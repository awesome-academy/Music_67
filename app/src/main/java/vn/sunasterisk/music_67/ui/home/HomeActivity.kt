...
import vn.sunasterisk.music_67.ui.search.ACTION_SEARCH_FROM_HOME
import vn.sunasterisk.music_67.ui.search.SearchActivity

class HomeActivity : BaseActivity(), HomeScreenContract.View, View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v) {
            buttonSearch -> startActivity(SearchActivity.getIntent(this, ACTION_SEARCH_FROM_HOME))
        }
    }
}
